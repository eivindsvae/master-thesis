...
def densitymatrix(integralstate, subsize):
    ...
    subsize: integer, the size of the subsystem
    Output:
...
ran = 2  #0.9 + abs(c) will usually work 
...
plt.title(r'Entanglement entropy $S(n)$')
...
plt.savefig("ententi.png", dpi=300, bbox_inches='tight') # Saving the figure locally
plt.show()
...
plt.savefig("julia_set_beauty2.png", dpi=300, bbox_inches='tight') # Saving the figure as a .png
plt.show()